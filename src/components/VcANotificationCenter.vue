                        ...
                        <ul class>
                            <li class="col s12">
                                <div class="bottomEntry">
                                    <a href="#test3" @click='changeStatusOfAllNotifies("deleted")'>
                            ...
                            <li class="col s4" style="display: none !important;">
                                <div class="bottomEntry">
                                    <a href="#test2">
  ...
  export default {
    ...
    methods: {
      ...
      updateStatusofNotifies: function (qry){
        ...
        ajaxx('DELETE', request, qry).then(function (events) {
          if (events) {
            if(events.success){
      ...
      changeStatusOfAllNotifies: function (newStatus){
        ...
        var qry = [];
        for(var x = 0; x < this.allNotifies.length; x++){
          qry.push({"type": this.allNotifies[x].notifyObject.type, "typeId": this.allNotifies[x].notifyObject.typeId, "status": newStatus});
        }
