<template>
    ...
    <div v-if="this.$cookies.get('access_token')" style="width: 100% !important;" >
        ...
        <div style="display: none !important">{{ $t("read.form.label.senderRoleName") }} i18 test </div>
        ...
        <a href="#" data-target="slide-out" class="sidenav-trigger" id="notificationCenter">
            ...
            <small id="notificationBadge">0</small>
        </a>
        ...
        <div>
            <ul id="slide-out" class="sidenav" style="background-color:#ededed !important;">
                        ...
                        <ul class="">
                            <li class="col s4">
                                <div class="bottomEntry">
                                    <a href="#test3">
                                        <i class="material-icons" href="#">clear_all
                                        </i>
                                        Alle löschen
                                    </a>
                                </div>
                            ...
                            <li class="col s4">
                                <div class="bottomEntry">
                                    <a href="#test2">
                                        <i class="material-icons" href="#">volume_up
                                        </i>
                                        Sound: An
                                    </a>
                                </div>
                            ...
                            <li class="col s4">
                                <div class="bottomEntry">
                                    <a href="#test1">
                                        <i class="material-icons" href="#">settings
                                        </i>
                                        Konfigurieren
                                    </a>
                                </div>
                ...
                <div class="row" id="stickyTab">
                    <li>
                        <div class="user-view">
                            <h5 style="text-align:center !important; padding-bottom: 0px !important; margin-bottom: 0px !important; margin-top:0px !important;">
                    ...
                    <div class="col s12">
                        <ul class="tabs">
                            <li class="tab col s3">
                                <a href="#tabAll">
                                    <i class="material-icons" href="#">view_column
                                    </i>
                                    Alle
                                </a>
                            </li>
                            ...
                            <li class="tab col s3">
                                <a href="#tabAction">
                                    <i class="material-icons" href="#">public
                                    </i>
                                    Aktion
                                </a>
                            </li>
                            ...
                            <li class="tab col s3">
                                <a href="#tabMessage">
                                    <i class="material-icons" href="#">chat
                                    </i>
                                    Nachricht
                                </a>
                            </li>
                            ...
                            <li class="tab col s3">
                                <a href="#tabDate">
                                    <i class="material-icons" href="#">date_range
                                    </i>
                                    Termin
                                </a>
                            </li>
                ...
                <div id="notificationContent">
                    ...
                    <div id="tabAll" class="col s12">
                        <VcANotificationBox v-for="notify in allNotifies" :notifyId="notify.notifyId"
                    ...
                    <div id="tabAction" class="col s12">
                        <VcANotificationBox v-for="notify in actionNotifies" :notifyId="notify.notifyId"
                                            :notifyHeading="notify.notifyHeading"
                                            :notifyIcon="notify.notifyIcon"
                                            :notifyType="notify.notifyType"
                                            :notifyActionLink="notify.notifyActionLink"
                    ...
                    <div id="tabMessage" class="col s12">
                        <VcANotificationBox v-for="notify in messageNotifies" :notifyId="notify.notifyId"
                                            :notifyHeading="notify.notifyHeading"
                                            :notifyIcon="notify.notifyIcon"
                                            :notifyType="notify.notifyType"
                                            :notifyActionLink="notify.notifyActionLink"
                    ...
                    <div id="tabDate" class="col s12">
                        <VcANotificationBox v-for="notify in dateNotifies" :notifyId="notify.notifyId"
                                            :notifyHeading="notify.notifyHeading"
                                            :notifyIcon="notify.notifyIcon"
                                            :notifyType="notify.notifyType"
                                            :notifyActionLink="notify.notifyActionLink"
...
<script>
  ...
  export default {
    ...
    mounted: function () {
      ...
      ajaxx('GET', 'http://localhost:8005/v1/events/notify', {}, auth).then(function (events) {
          ...
          for(var i = 0; i < events.length; i++){
            ...
            var newNotify = {
              ...
              "notifyIcon": this.getIconName(notifyType),
              "notifyType": "ACTION",
              "notifyHeading": "",
